...
* Cómo se ejecuta un programa de python

Primero, la forma en que un programa se ejecuta es de la siguiente forma:

#+begin_src plantuml :file ejecucion.png
HDD -> SO: Comunicación desde el disco duro hacia el sistema operativo
SO -> App: Envio de datos del SO hacia la aplicación
App -> SO: Respuesta de la aplicación hacia el sistema operativo
SO -> Monitor: Despliegue de la información desde el SO hacia el monitor
Monitor -> SO: Envío de acciones de usuario hacia el SO
SO -> HDD: Almacenamiento de datos desde la aplicación (gestiona el SO).
#+end_src

#+RESULTS:
[[file:ejecucion.png]]

En python funciona de la siguiente forma:

#+begin_src plantuml :file ejecucion-python.png
  HDD -> SO
  SO -> HDD
  SO -> App
  App -> SO
  SO -> "Interprete de python"
  "Interprete de python" -> SO
  "Interprete de python" -> "Programa en python"
  "Programa en python" -> "Interprete de python"
  SO -> Monitor
  Monitor -> SO
#+end_src

#+RESULTS:
[[file:ejecucion-python.png]]
